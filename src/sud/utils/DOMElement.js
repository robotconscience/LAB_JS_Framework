...
* @param parent (optional) either SUD.utils.DOMElement or string
*/
SUD.utils.DOMElement = function( id, parent ){
	this.timeouts = {};
	if (id){
		if (parent){
			...
			} else if (parent.type && parent.type == "SUD.utils.DOMElement"){
				this.parent = parent;
...
SUD.utils.DOMElement.prototype = {
	/** @function */
	set x( val ){
		if (this.left != val)
...
*/
SUD.utils.DOMElement.prototype.clearTimeout = function( name ){
...
SUD.utils.DOMElement.prototype.setTimeout = function( callback, time, name ){
	this.clearTimeout( name );
	this.timeouts[name] = window.setTimeout( callback, time );
}

/** @function */
SUD.utils.DOMElement.prototype.hide = function(){
	this.element.style.visibility = "hidden";
	this.element.style.display 	= "none";
}

/** @function */
SUD.utils.DOMElement.prototype.show = function(){
	this.element.style.visibility = "visible";
	this.element.style.display	  = "block";
}

/** @function */
SUD.utils.DOMElement.prototype.update = function(){
...
*/
SUD.utils.DOMElement.prototype.clone = function( bIncludeChildren ){
...
/** 
* Add regular DOM element or SUD DOMElement
* @function 
* @param	{Object, SUD.utils.DOMElement} domElement
*/
SUD.utils.DOMElement.prototype.add	= function( domElement ){
	if ( domElement.type && domElement.type == "SUD.utils.DOMElement" ){
...
/** 
* Remove regular DOM element or SUD DOMElement
* @function 
* @param	{Object, SUD.utils.DOMElement} domElement
*/
SUD.utils.DOMElement.prototype.remove	= function( domElement ){
	if ( domElement.type && domElement.type == "SUD.utils.DOMElement" ){
		try {
