...
SUD.three.ParticleEmitter = function ( parameters ) {
   ...
   for(var i=0; i<this.maxParticleCount; i++){
      ...
      else this.particles[i] = new sudParticle();
   }
   ...
   this.shader = new SUD.three.Shader({name: "shaders/basicParticle",
...
//SUD.three.ParticleEmitter.prototype.makeGeometry = function(){
//   
//}


//SUD.three.ParticleEmitter.prototype.makeShader = function( tex ){
//   
//   var vString =
...
//   }};
//   
//   var normMat = new SUD.three.Shader();
//   normMat.loadFromString( vString, fString, parameters );
//   return normMat;
//};

SUD.three.ParticleEmitter.prototype.addParticle = function( pos, vel, col, radius, currentTime, lifespan) {
   if(this.particleSystem.geometry.__webglParticleCount < this.maxParticleCount - 1){
      ...
      this.particles[i].birth = this.attributes.birth.value[i] = currentTime || SUD.getElapsedTimeSeconds();
...
SUD.three.ParticleEmitter.prototype.removeParticle = function( index ){
