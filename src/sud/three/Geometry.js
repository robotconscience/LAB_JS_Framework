...
SUD.three.Geometry.prototype = new THREE.Geometry();
SUD.three.Geometry.prototype.constructor = SUD.three.Geometry;
SUD.three.Geometry.prototype.supr = THREE.Geometry.prototype;
...
SUD.three.Geometry.prototype.loadModel = function( modelLocation, callback ){
   var loader = new THREE.JSONLoader( true );
   callback = callback || function( geometry ) { return geometry };
   loader.load( { model: modelLocation, callback: callback });
};

SUD.three.Geometry.prototype.loadSudModel = function( model ){
   //vertex positions
...
/**
 ...
 @public
 */
SUD.three.Geometry.prototype.addVertex = function( x,y,z){
...
/**
	...
	@public
*/
SUD.three.Geometry.prototype.addFace = function( i0, i1, i2 ){
...
/**
	...
	@public
*/
SUD.three.Geometry.prototype.update = function(){
...
/**
	...
	@public
*/
SUD.three.Geometry.prototype.calculateNormals = function( _smooth ){
...
SUD.three.Geometry.prototype.getPointOnFace = function( faceIndex, u, v ){
...
SUD.three.Geometry.prototype.getSmoothedNormalOnFace = function( faceIndex, u, v ){
   var f = this.faces[Math.min( faceIndex, this.faces.length - 1)];
...
SUD.three.Geometry.prototype.findEdges = function(){
...
SUD.three.Geometry.prototype.findVertexEdges = function(){
...
SUD.three.Geometry.prototype.findVertexFaces = function(){
...
SUD.three.Geometry.prototype.findFaceEdges = function(){
   if(this.edges.length == 0){
      this.findEdges();
   }
...
SUD.three.Geometry.prototype.getFaceNormal = function( faceIndex ){
   return this.faces[ faceIndex ].normal;
};
SUD.three.Geometry.prototype.getVertexNormal = function( vertexIndex ){
...
SUD.three.Geometry.prototype.calcVertexNormal = function( vertexIndex ){
   //not as easy as it sounds in three o_O
...
SUD.three.Geometry.prototype.calculateVertexNormals = function(){
   for(var i=0; i<this.vertices.length; i++){
...
SUD.three.Geometry.prototype.getVertexLocalPosition = function( vertexIndex ){
