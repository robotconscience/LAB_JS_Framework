namespace("SUD.three.MouseHandler3D");
 ...
 */
SUD.three.MouseHandler3D = function(scene, camera) {
	"use strict";
				...
				if (hash[hitObject.id]) {
					...
					if (hitObject === hash[hitObject.id].object) {
						...
						if (events != undefined && events.indexOf(type) > -1) {
							...
							self.dispatchEvent(new SUD.three.MouseEvent3D(type), params);
						}
					} else {
	...
	function onMoveEvent(evt) {
		handleEvent(SUD.three.MouseEvent3D.MOVE, evt);
	}
	...
	function onDownEvent(evt) {
		handleEvent(SUD.three.MouseEvent3D.DOWN, evt);
	}
	...
	function onUpEvent(evt) {	
		...
		handleEvent(SUD.three.MouseEvent3D.UP, evt);
	}
	...
	function onClickEvent(evt) {
		handleEvent(SUD.three.MouseEvent3D.CLICK, evt);
	}
	...
	function onOverEvent(evt) {
		handleEvent(SUD.three.MouseEvent3D.OVER, evt);
	}
	...
	function onOutEvent(evt) {
		handleEvent(SUD.three.MouseEvent3D.OUT, evt);
	}	
...
SUD.three.MouseHandler3D.prototype = SUD.inherit(SUD.EventDispatcher.prototype);
SUD.three.MouseHandler3D.prototype.constructor = SUD.three.MouseHandler3D;

namespace("SUD.three.MouseEvent3D");
 ...
 */
SUD.three.MouseEvent3D = function(type) {
	"use strict";
...
/** @constant */
SUD.three.MouseEvent3D.DOWN = "mouse3DDown";
/** @constant */
SUD.three.MouseEvent3D.UP = "mouse3DUp";
/** @constant */
SUD.three.MouseEvent3D.MOVE = "mouse3DMove";
/** @constant */
SUD.three.MouseEvent3D.OVER = "mouse3DOver";
/** @constant */
SUD.three.MouseEvent3D.OUT = "mouse3DOut";
/** @constant */
SUD.three.MouseEvent3D.CLICK = "mouse3DClick";


SUD.three.MouseEvent3D.prototype = SUD.inherit(SUD.Event.prototype);
SUD.three.MouseEvent3D.prototype.constructor = SUD.three.MouseEvent3D;
