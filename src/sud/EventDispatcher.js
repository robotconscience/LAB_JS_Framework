 ...
 */
SUD.EventDispatcher = function(target)
{
...
SUD.EventDispatcher.prototype = {
	constructor:SUD.EventDispatcher,
	/**
	 ...
	 *
	 * @example
	 * someObject.dispatchEvent(new SUD.Event(Event.CHANGE));
	 * @example
	 * var params = {secret: "my secret", message: "hi"};
	 * someObject.dispatchEvent(new SUD.Event("customEventType"), params);
	...
	dispatchEvent:function(typeOrEvent, optionalParams){
		...
		if (typeof typeOrEvent === 'string') {
			var event = new SUD.Event(typeOrEvent);
 ...
 */
SUD.Event = function(type) {
	this.type = type;
	this.target = null;
}

/** @constant */
SUD.Event.CONNECTED = "connected";
/** @constant */
SUD.Event.CHANGE	= "change";
/** @constant */
SUD.Event.COMPLETE	= "complete";